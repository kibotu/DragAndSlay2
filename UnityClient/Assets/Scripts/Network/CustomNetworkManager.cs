...
namespace Assets.Scripts.Network
{
    public class CustomNetworkManager : NetworkManager
    {
        ...
        {
            Debug.Log("[SetIPAddress] " + singleton.networkAddress);
        }

        public void SetPort()
        {
            singleton.networkPort = 1337;
            Debug.Log("[SetPort] " + singleton.networkPort);
        }
            ...
            NetworkReader extraMessageReader)
        {
            ...
            Debug.Log("[OnServerAddPlayer] " + conn + " " + playerControllerId + " player: " +
                      singleton.numPlayers + " reader " + extraMessageReader);
        }

        public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
        {
            Debug.Log("[OnServerAddPlayer] " + conn + " " + playerControllerId + " player: " +
                      singleton.numPlayers);
